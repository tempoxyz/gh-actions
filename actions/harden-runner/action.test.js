...
const wrapperPattern =
  /uses:\s+tempoxyz\/gh-actions\/actions\/secure-runner@aaedf7a275e398ad81b2913d9a6cbfce791ecbfb/;
    ...
    for (const jobBlock of jobBlocks) {
      ...
      if (usesProtectedWorkflow) {
        ...
        assert.match(
          steps,
          new RegExp(
            String.raw`^(?:\s*#[^\n]*\n)*\s*- (?:name:[^\n]+\n\s+)?uses:\s+tempoxyz/gh-actions/actions/secure-runner@aaedf7a275e398ad81b2913d9a6cbfce791ecbfb[^\n]*`,
          ),
