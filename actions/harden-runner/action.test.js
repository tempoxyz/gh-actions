...
const wrapperPattern =
  /uses:\s+tempoxyz\/gh-actions\/actions\/secure-runner@10b0d5182ead76a63716ac5fc2aa8fd7b7f42795/;
    ...
    for (const jobBlock of jobBlocks) {
      ...
      if (usesProtectedWorkflow) {
        ...
        assert.match(
          steps,
          new RegExp(
            String.raw`^(?:\s*#[^\n]*\n)*\s*- (?:name:[^\n]+\n\s+)?uses:\s+tempoxyz/gh-actions/actions/secure-runner@10b0d5182ead76a63716ac5fc2aa8fd7b7f42795[^\n]*`,
          ),
