...
test("uses both STS exchanges and the aegis download policy", () => {
  assert.match(manifest, /actions\/socket-sts@96e969f0226e938cac6ea1978141867a0fbf031b/);
  assert.match(manifest, /actions\/aegis-report@96e969f0226e938cac6ea1978141867a0fbf031b/);
  assert.ok(
