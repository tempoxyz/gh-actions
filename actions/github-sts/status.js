...
// main.js loads this module, so the defaults are resolved lazily to avoid a
// load-time cycle; callers normally inject their budget-bounded request.
const REQUEST_TIMEOUT_MS = 10 * 1000;
const httpRequest = (...args) => require("./main.js").request(...args);

const SERVICE = "GitHub STS";
const USER_AGENT = "tempoxyz-gh-actions-github-sts";
