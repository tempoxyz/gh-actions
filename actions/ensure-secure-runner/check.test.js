...
const SECURE = "tempoxyz/gh-actions/actions/secure-runner@9714ff353c4199ff9f498205ef7b3319869dd51d";
...
test("the job that only checks out and runs ensure-secure-runner is exempt, nothing else is", async () => {
  const ENSURE = "tempoxyz/gh-actions/actions/ensure-secure-runner@9714ff353c4199ff9f498205ef7b3319869dd51d";
