...
const SECURE = "tempoxyz/gh-actions/actions/secure-runner@d0bd3f715fb4efadb78897db98fe87e7c94a6d95";
...
test("the job that only checks out and runs ensure-secure-runner is exempt, nothing else is", async () => {
  const ENSURE = "tempoxyz/gh-actions/actions/ensure-secure-runner@d0bd3f715fb4efadb78897db98fe87e7c94a6d95";
