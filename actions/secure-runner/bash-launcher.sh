...
_tempo_sfw_launch() {
  ...
  local _tempo_sfw_binary _tempo_sfw_upstream _tempo_sfw_previous _tempo_sfw_node _tempo_sfw_bash _tempo_sfw_guard
  ...
  # Node needs a native script path even when MSYS argument conversion is disabled.
  exec "$_tempo_sfw_node" "$_tempo_sfw_guard" "$_tempo_sfw_bash" "$_tempo_sfw_binary" "$real" "$@"
}
