...
test("pins the merged Socket Firewall with Aegis diagnostics and pending-scan policy", () => {
  assert.match(
    manifest,
    /uses: tempoxyz\/gh-actions\/actions\/socket-firewall@4a5ecd87e0314508adc4743d82221e0459402df9/,
  );
});
