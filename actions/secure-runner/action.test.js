...
test("pins Socket Firewall with stuck-assertion recovery and bundled Node", () => {
  assert.match(
    manifest,
    /uses: tempoxyz\/gh-actions\/actions\/socket-firewall@10e0ccdd1a68d5d5f4f3fe0083d48ea1863fc1e8/,
  );
