...
test("pins the merged Socket Firewall with the standalone Socket STS action", () => {
  assert.match(
    manifest,
    /uses: tempoxyz\/gh-actions\/actions\/socket-firewall@d6d3bb4601a782b27a38e124ccf96fe93e4d5d7b/,
  );
});
