...
function isErrorResponse(value) {
	...
	for (const error of obj.errors) if (typeof error !== "object" || error === null || !("detail" in error) || typeof error.detail !== "string") return false;
	return true;
}
async function throwHttpErrorMessage(operation, response) {
	...
	if (responseText) try {
		...
		if (isErrorResponse(parsed)) {
			for (const error of parsed.errors) errorMessage += ` Error: ${error.detail}`;
...
//#endregion
export { runAction as a, getInput as c, saveState as d, setOutput as f, getUserAgent as i, getState as l, TOKEN_KEY as n, throwHttpErrorMessage as o, setSecret as p, getTokensEndpoint as r, getIDToken as s, REGISTRY_URL_KEY as t, info as u };
