...
| [`gradle/actions`](https://github.com/gradle/actions/blob/ed408507eac070d1f99cc633dbcf757c94c7933a/README.md) | v4.4.3 (`ed40850`) | A collection of actions for building Gradle projects, as well as generating a dependency graph via Dependency Submission. |
