...
- `online-audits` (default: `true`) — enable zizmor's GitHub API audits; set to `false` when the caller token cannot read referenced private repositories. Static security audits and actionlint still run.
